...
public class FieldView extends javax.swing.JPanel
{
    ...
    {//GEN-HEADEREND:event_formMouseClicked
		...
		final FieldModel field = backend.getCurrentState ();
		System.out.println (getXRealCoord(field, evt.getX ()) + ", " + getYRealCoord(field, evt.getY()));
    }//GEN-LAST:event_formMouseClicked

	private double getXRealCoord (FieldModel field, int x)
	{
		return field.getWidth()*(x - viewBounds.getX())/viewBounds.getWidth();
	}

	private double getYRealCoord (FieldModel field, int y)
	{
		return -1*field.getHeight()*(y -viewBounds.getY() - viewBounds.getHeight())/viewBounds.getHeight();
	}
